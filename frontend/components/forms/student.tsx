...
const formSchema = z.object({
   ecole: z.string().min(6, {
    ...
    }).nonempty({message:"Le email est requis"}),
  username: z.string().min(3, {
    message: "Le nom d'utilisateur doit contenir au moins 4 caractères.",
  }),
  matricule: z.string().min(6, {
    message: "Le matricule doit contenir au moins 8 caractères.",
  }),
...
export function StudentForm() {
  ...
  return (
    <Card className="w-full shadow-none bg-transparent border-none text-neutral-700">
      <CardContent>
        <Form {...form}>
