...
const formSchema = z.object({
  ...
  }).nonempty({message:"Le nom et prenom de l'eleve est requis"}),
  matricule: z.string().min(6, {
    message: "Le mot de passe doit contenir au moins 6 caractères.",
  }).nonempty({message:"Le matricule est requis"}),
...
export function ParentForm() {
  ...
  return (
    <Card className="w-full bg-transparent shadow-none border-none text-neutral-700">
      <CardContent>
        <Form {...form}>
          ...
          <FormField
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="dark:text-neutral-200">Nom et prenoms de eleve</FormLabel>
                  <FormControl>
                    <Input 
                      placeholder="johndoe" 
                      className="dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-100 placeholder:text-neutral-500 text-neutral-600"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="dark:text-neutral-200">Numero Matricule de eleve</FormLabel>
                  <FormControl>
                    <Input
                      type="password"
                      placeholder="••••••••"
